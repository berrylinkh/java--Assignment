...
public class NokiaFrontAndBackTest{
public static void main(String[]args){
Scanner inputCollector = new Scanner(System.in);

	boolean forNokiaMenu = true;
	while(forNokiaMenu){	String nokiaMenu ="""
...
while (forOption){	
		...
		switch(optionMenuList){
			...
			case 0:System.out.println("Back to phonebook"); 
				forOption = false;
			break;
		...
		case 10:  System.out.println("voiceTags");break;
...
System.out.println("message"); 
	...
	switch(messageSettings){
		...
		case 7:  System.out.println("Message settings");
			boolean forMessageSettings = true;
while(forMessageSettings){
...
String set1Menu = """
	...
	switch(set1MenuList){
		...
		case 0:System.out.println("Back to message settings menu");
			forSet1 = false;
 			break;
...
while(forCommon){
	...
	switch(commonMenuList){
		...
		case 0:System.out.println("Message settings menu");
			forCommon = false;
			break;
		default:System.out.println("Invalid out");
			}
...
case 4: 
boolean forCallRegister = true;
while(forCallRegister) {
	...
	switch(callRegisterMenuList){
		...
		case 5:  System.out.println("Show all call Duration"); 
			boolean forShowAllCallDuration = true;
	while(forShowAllCallDuration) {
	...
	switch(showAllCallDurationMenuList){
		...
		case 0:  System.out.println("Back to call register");
			forShowAllCallDuration = false;
		 break;
		default: System.out.println("Invalid input"); 
			}
		}
		break;
case 6: boolean forShowCallCost = true;
	while(forShowCallCost) {
	...
	switch(showCallCostMenuList){
		...
		break;
case 7: 
boolean forCallCostSettings = true;
while(forCallCostSettings) {
...
String callCostSettingsMenu = """
	...
	switch(callCostSettingsMenuList){
		...
		case 0:  System.out.println("Back to Nokia menu");
			forCallRegister = false;
		 	break;
		default:System.out.println("Invalid input"); 
			}
		}
...
case 1: 
boolean forCallSettings = true;
while(forCallSettings) {
...
String callSettingsMenu = """
	...
	switch(callSettingsMenuList){
		...
		case 0:  System.out.println("Back to settings");
			forCallSettings = false;
			break;
		default:System.out.println("Invalid input"); 
				}
			}
...
case 2:
boolean forPhoneSettings = true;
while(forPhoneSettings) {
...
case 3:  
boolean forSecuritySettings = true;
while(forSecuritySettings) {
